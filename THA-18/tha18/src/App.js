  ...
  return (
    ...
    <div className='container'>
      <div style={styles}>
        ...
        <Item item="C++" explain='1' val={val}/>
        <Item item="C" explain='2' val={val} />
        <Item item="Javascript" explain='3' val={val} />
        <Item item="DSA" explain='2'  val={val}/>
        <Item item="Algorithms" explain='5' val={val} />
